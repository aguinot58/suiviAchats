...
class RolesController extends AbstractController
{
    ...
    /**
     * @Route("/{idRole}", name="app_roles_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{idRole}/edit", name="app_roles_edit", methods={"GET", "POST"})
     */
    ...
    /**
     * @Route("/{idRole}", name="app_roles_delete", methods={"POST"})
     */
    public function delete(Request $request, Roles $role, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$role->getIdRole(), $request->request->get('_token'))) {
