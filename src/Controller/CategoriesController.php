...
class CategoriesController extends AbstractController
{
    ...
    /**
     * @Route("/{idCat}", name="app_categories_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{idCat}/edit", name="app_categories_edit", methods={"GET", "POST"})
     */
    ...
    /**
     * @Route("/{idCat}", name="app_categories_delete", methods={"POST"})
     */
